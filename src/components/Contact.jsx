                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-center space-x-6">
                                ...
                                <a href="https://youtube.com/@iqgstc" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-600 transition duration-300 transform hover:scale-110">
                                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
