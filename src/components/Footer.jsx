                ...
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-6">
                            ...
                            <a href="https://wa.me/919003889990" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 transition duration-300 transform hover:scale-110">
                                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://www.youtube.com/@IQGlobalSkillsTrainingCentre" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition duration-300 transform hover:scale-110">
                                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
