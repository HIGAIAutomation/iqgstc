...
const Header = () => {
    ...
    return (
        <motion.header
            className={`w-full py-3 md:py-4 transition-all duration-500  ${isSticky
                ...
                <div className="flex justify-between items-center">
                    ...
                    >
                        ...
                        <Link to="/" className="hidden sm:block text-lg sm:text-xl md:text-3xl font-display font-bold text-black hover:text-blue-600 transition-colors duration-300 truncate md:whitespace-normal">
                            IQ Global Skill Training Centre
                        </Link>
                                ...
                                {item.dropdown ? (
                                    <>
                                        <button
                                            ...
                                            className={`relative font-body font-medium text-sm xl:text-lg transition-all duration-300 hover:text-gray-500 group flex items-center whitespace-nowrap ${location.pathname === item.path ? 'text-black' : 'text-gray-600'
                                                }`}
                                        >
                                            {item.label}
                                            ...
                                            <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-600 to-pink-400 transition-all duration-300 group-hover:w-full ${location.pathname === item.path ? 'w-full' : ''
                                                }`}></span>
                                        </button>
                                    ...
                                    <Link
                                        to={item.path}
                                        className={`relative font-body font-medium text-sm xl:text-lg transition-all duration-300 hover:text-gray-500 group whitespace-nowrap ${location.pathname === item.path ? 'text-black' : 'text-gray-600'
                                            }`}
                                    >
                                        {item.label}
                                        <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-purple-600 to-pink-400 transition-all duration-300 group-hover:w-full ${location.pathname === item.path ? 'w-full' : ''
                                        ...
                                        >
                                            {item.dropdown ? (
                                                ...
                                                <Link
                                                    to={item.path}
                                                    onClick={closeMobileMenu}
                                                    className={`block py-2 sm:py-3 px-3 sm:px-4 rounded-lg font-body font-medium text-sm sm:text-lg transition-all duration-300 ${location.pathname === item.path
